...
import { FaTools, FaTags, FaArrowCircleRight } from 'react-icons/fa';
...
import ClasificacionControl from '@/components/02_Almacenes/AlmacenGeneral/Parametros/Clasificaciones/ClasificacionControl'
...
const Main_ConfigContabilidadControl: React.FC = () => {
  ...
  // Estados para vistas (Métodos, Clasificación)
    ...
    <>
      <header>
        <div className='returnButton'>
          {isOpenMetodos || isOpenClasificacion ?
  ...
  return (
    <div className="mainDiv_ConfigContabilidad">
      {isOpenMetodos ? renderMetodos() : isOpenClasificacion ? renderClasificacion() : renderMenu()}
    </div>
  );
};
