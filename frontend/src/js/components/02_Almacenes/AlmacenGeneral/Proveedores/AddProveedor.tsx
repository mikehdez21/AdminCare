...
import { addProveedor, getProveedores, getTiposDescuento, getTiposProveedores } from '@/store/almacenGeneral/Proveedores/proveedoresActions';
...
const AddProveedor: React.FC<AddProveedorProps> = ({ isOpen, onClose }) => {
  ...
  const tiposProveedor = useSelector((state: RootState) => state.proveedor.tiposProveedores);
  ...
  const tiposDescuento = useSelector((state: RootState) => state.proveedor.descuentosProveedor);
      ...
      <div className="mainDiv_modalProveedores">
        ...
        <form onSubmit={handleSubmit} className="formProveedores">
          ...
          <div className='dataInputs_Proveedor'>
            ...
            <section className='addProveedor_FirstColumn'>
              <label>
            ...
            <section className='addProveedor_SecondColumn'>
              ...
              <label>
                *Tipo de Moneda de Pago
                ...
                >
                  <option value="" disabled>Selecciona un tipo de moneda</option>
            ...
            <section className='addProveedor_ThirdColumn'>
              <label>
                *Tipo de Proveedor
                <select
                  required
                ...
                >
                  <option value="" disabled>Selecciona un tipo de proveedor</option>
              ...
              <label>
                *Tipo de Regimen
                ...
                >
                  <option value="" disabled>Selecciona un tipo de regimen</option>
              ...
              <label>
                *Descuentos del Proveedor
                ...
                >
                  <option value="" disabled>Selecciona un tipo de descuento</option>
              ...
              <label>
                *Tipo de Facturación
                ...
                >
                  <option value="" disabled>Selecciona un tipo de facturación</option>
