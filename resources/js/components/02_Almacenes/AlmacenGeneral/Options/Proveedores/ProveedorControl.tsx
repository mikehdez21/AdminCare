...
import { getTiposProveedores, getFormasPago, getTiposRegimen, getTiposDescuento, getTiposFacturacion, getTiposMoneda} from '@/store/almacenGeneral/Tipos/almacenGeneralTipos_Actions';
...
// Styles
import '@styles/02_Almacenes/AlmacenGeneral/proveedoresControl.css';
...
const AlmacenGeneral_ControlProveedor: React.FC = () => {
  ...
  const tiposProveedores = useSelector((state: RootState) => state.tiposAlmacenGeneral.tiposProveedores);
  ...
  const descuentosProveedor = useSelector((state: RootState) => state.tiposAlmacenGeneral.descuentosProveedor);
